...
export default function Home() {
  ...
  return (
    <div className={`${openSans.className} min-h-screen bg-red-600`}>
      ...
      {showSuccessStories ? (
        <main className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gray-50 px-4 py-20">
          <button
            onClick={() => setShowSuccessStories(false)}
            className="mb-8 px-4 py-2 bg-red-600 text-white rounded-full font-bold hover:bg-red-700 transition"
          >
            ← Back
          </button>
          <SuccessStories />
